...
# 开发者证书
certificate="Apple Development: Lee Han (2TTSFSXGUZ)"
# 发布版本
version=8.0.5
BundleVersion=8.0.5.32
WeChatBundleVersion=8.0.5.32
...
/usr/libexec/PlistBuddy -c "Set :WeChatBundleVersion $WeChatBundleVersion" "${path}/Info.plist"
...
# 4. 生成新成ipa
rm -rf  ./profile.plist ./entitlements.plist
zip -rq "new_$1" ./Payload
mv ./"new_$1" ../
